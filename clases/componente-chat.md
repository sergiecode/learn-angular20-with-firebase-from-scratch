# 💬 Clase 13: Componente de Chat con Angular 20, Firebase y Google Gemini API
...
## 🎯 Objetivo
Este documento describe los pasos e implementación inicial del componente **Chat** dentro de un proyecto en Angular 20 con Firebase, pensado para crear un chat que posteriormente integrará la API de Google Gemini. 
